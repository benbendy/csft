...
while (i<len(sys.argv)):
	...
	if arg=='-h' or arg=='--host':
		...
		mode = SPH_MATCH_ANY
                print "321dddddddddddddddddd"
	elif arg=='-b' or arg=='--boolean':
		mode = SPH_MATCH_BOOLEAN
                print "21dddddddddddddddddd"
	elif arg=='-e' or arg=='--extended':
		mode = SPH_MATCH_EXTENDED
                print "1dddddddddddddddddd"
	elif arg=='-expr':
		mode = SPH_MATCH_EXPR
...
field_weight = {}
field_weight['place_name'] = 30
field_weight['address'] = 20
field_weight['food_name'] = 20

cl.SetFieldWeights(field_weight)
...
if sortby:
	...
	cl.SetSortMode ( SPH_SORT_EXPR, 'score + @weight' )
if limit:
